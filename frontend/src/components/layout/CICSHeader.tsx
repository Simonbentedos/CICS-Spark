    ...
    <header className="sticky top-0 z-50 w-full">
      ...
      <div className="bg-bg-grey flex items-center justify-between px-8 lg:px-[280px] py-2">
        ...
        <Link href="/" className="flex items-center gap-2.5 no-underline shrink-0">
          <Image src="/images/CICS SEAL.png" alt="CICS Seal" width={41} height={51} className="h-[51px] w-[41px] object-contain" />
          <div className="flex flex-col">
            <span className="font-body text-cics-maroon text-[8px] leading-tight">The</span>
            <span className="font-heading font-bold text-cics-maroon text-[14px] leading-tight">College of Information and Computing Sciences Repository</span>
            <span className="font-heading font-bold text-[10px] leading-tight" style={{ color: 'var(--cics-maroon)' }}>University of Santo Tomas</span>
          </div>
        </Link>
