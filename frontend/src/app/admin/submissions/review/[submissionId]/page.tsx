...
export default function SubmissionReviewPage({
  params,
}: Readonly<{ params: { submissionId: string } }>) {
            ...
            <CardContent className="space-y-4 p-4">
              ...
              <div className="grid gap-3 text-xs text-grey-600 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <p className="text-grey-700">{(submission.authors as string[]).join(', ')}</p>
              ...
              {(submission.keywords as string[]).length > 0 && (
                <div className="space-y-2 border-t border-grey-200 pt-3">
                  <p className="text-xs uppercase text-grey-500">Keywords</p>
                  <div className="flex flex-wrap gap-2">
                    {(submission.keywords as string[]).map((keyword) => (
          ...
          <Card className="border border-grey-200 shadow-none">
            ...
            <CardContent className="space-y-2">
              ...
              <Button
                ...
                disabled={submitting || submission.status === 'rejected'}
              >
                ✕ Reject
              </Button>
            </CardContent>
